 <?php
          ...
          if($row == $current){
            ?>
          <div class="row">
          <div class="col-md-12 configbarIn">
            <div class="col-md-2">
            <label>Device</label>
         ...
         <label class="nameprotocol<?php echo $s;?>" style="">Protocol</label>
          ...
          <script type="text/javascript">
            $(document).ready(function(){
                  ...
                  if (onloaddev=="Laptop"||onloaddev=="Desktop"||onloaddev=="DVD/Blue Ray"||onloaddev=="Conference"||onloaddev=="Apple TV"){
          ...
          <select style="width: 110px;height: 20px;" id="devicename<?php echo $s; ?>" class="device" isid="<?php echo $s; ?>">
            ...
            <?php 
              ...
              ?> 
               <option value="Add" class="inputdeviceadd">Add...</option> 
            </select>
          </div>
          <div class="col-md-2">
