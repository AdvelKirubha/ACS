 <?php
         ...
         <label class="nameprotocol<?php echo $s;?>" style="display: none;">Protocol</label>
          ...
          <div class="col-md-2">
          <input type="button" value="save" class="button button<?php echo $s; ?>" isid="<?php echo $s; ?>" name="save" style="background: #CF0A2C;color: white; height:20px;   margin-top: 18; display: none;" > 
          </div>
          <div class="col-md-2">
          <input type="button" value="update" class="update update<?php echo $s; ?>" isid="<?php echo $s; ?>" name="update" style="background: #CF0A2C;color: white; display: none;height: 20x;   margin-top: 18px;" > 
          </div>
          </div>
          </div>
