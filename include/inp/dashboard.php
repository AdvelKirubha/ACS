...
<body class="">
    ...
    <div id="log" title="ACS Log" style="display: none;">
        <?php include "include/inp/logs.php" ?>
    </div>
   ...
   <?php include "include/inp/addsiteDialog.php" ?>
    ...
    <div id="editsite" title="Editsite" style="display: none; overflow: hidden;">
              ...
              $(document).ready(function() {
                ...
                if ($option ==7){
                   if($devid ==0){
                    ...
                    alert("please select site or subsite from tree");
                   }
                    
                }
                if ($option == 8){
                    if($devid == 0){
                    alert("please select device from tree");
                   }else{

                    
                    
                    var deldevid ="id="+$devid+"&subsiteID="+$selsubsiteID+"&siteID="+$selsiteID;
    ...
    $('#left_sites_nav_tree__').on("changed.jstree", function (e, data) {
        ...
        //console.log(data.selected['0']);
                ...
                if ($isid == 'image0') {} else if ($isid == 'image1') {} else {
                    ...
                    var dataString = "DeviceID="+devid+"&siteID="+siteconfig;
            ...
            "action": function (obj) { 
                ...
                if($selsubsiteID == 0 && $devid == 0){
                   ...
                   // var pastesitename = sitename+"_1";
                    var copyParentString = "siteid="+siteid+"&pastesitename="+pastesitename+"&issubsites="+hassubsite;
                    ...
                    var copySubsiteString = "siteid="+siteid+"&pastesitename="+pastesitename+"&subsiteID="+subsiteid;
