<?php
 if(isset($_POST['submit1']))
 {
    ...
    mysql_query("insert into addsite (UserID,IPAddress, ElementName, Description, Suite, City, Country, Latitude, Street, State, Zip, Longitute) values('$UserID','$IPAddress','$ElementName','$Description','$Suite','$City','$Country','$Latitude','$Street','$State','$Zip','$Longitute')") or die(mysql_error()); 

     mysql_query("SET @user1 = LAST_INSERT_ID()");

    mysql_query("insert into treeview_items (name,text,parent_id,isdeveicesiteID,issit) values('$ElementName','$ElementName','1',@user1,@user1)") or die(mysql_error()); 
?>
...
?>
                         ...
                         <div class="site" style="display:none;"  title="Add Site">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-md-offset-6">
                                                    <button type="submit" name="submit1"  class="btn btn-default">Save</button>&nbsp;&nbsp;
